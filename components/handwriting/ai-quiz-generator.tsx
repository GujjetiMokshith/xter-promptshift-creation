              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-gray-500">
                    💡 Add your own content to create highly specific quizzes
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={type.id} className="flex items-center space-x-2 p-2 border border-gray-200 rounded-lg">
                        <input
                          type="checkbox"
                          id={type.id}
                        ...
                        />
                        <Label htmlFor={type.id} className="text-sm flex items-center gap-1 cursor-pointer">
